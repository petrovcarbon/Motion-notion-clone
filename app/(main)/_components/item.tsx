...
export const Item = ({
        ...
        return(
                ...
                onClick={onClick} 
                role="button" 
                style={{paddingLeft: level ? `${(level*14)+14}px` : "14 px"}} 
                className={cn(
                        ...
                        {!!id && (
                                <div role="button" className="h-full rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 mr-1" onClick={handleExpand}>
                                        <ChevronIcon className="h-6 w-6 shrink-0 text-muted-foreground/50 ml-2" />
                                </div>
                        )}
                        {documentIcon ? (
                                ...
                                <Icon className="shrink-0 h-[22px] w-[22px] ml-2 mr-2 text-muted-foreground"/>
                        )}
...
Item.Skeleton = function ItemSkeleton({level}: {level?: number}) {
        return(
                <div 
                style={{paddingLeft: level ? `${(level * 14)+25}px` : "14px"}}
