                        ...
                        <PopoverTrigger asChild>
                                <Button size="sm" variant="ghost"> 
                                        ...
                                        {initialData.isPublished && (
                                                <Globe className="text-shadow-neutral-600 w-4 h-4 ml-2"/>
                                        )}
                                </Button>
                        </PopoverTrigger>
                                        ...
                                        {initialData.isPublished ? (
                                                <div className="space-y-4">
                                                        <div className="flex items-center gap-x-2">
                                                                <Globe className="text-neutral-600 animate-pulse h-4 w-4"/>
                                                                <p className="text-xs font-medium text-neutral-600">
                                                                        This note is published.
                                                                </p>
                                                        </div>
                                                        <div className="flex items-center">
                                                                <input className="flex-1 px-2 text-xs border rounded-l-md h-8 truncate bg-muted" value={url} disabled/>
